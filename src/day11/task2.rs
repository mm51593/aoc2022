...
impl Monkey {
    ...
    pub fn add_to_throw_list(&self, item: u64, list: &mut LinkedList<(usize, u64)>, divisor: u64) {
    ...
    for _ in 0..ROUNDS {
        for monkey in 0..monkeys.len() {
            ...
            for item in monkeys[monkey].items.iter() {
                monkeys[monkey].add_to_throw_list(*item, &mut throw_list, divisor);
            }
